...
class TfidfTopology
{
  ...
  public TfidfTopology(String topologyName,String spoutTopic, String reportTopic) {
  ...
  private void wireTopology(String spoutTopic, String reportTopic) {
    ...
    builder.setBolt(reporterId, new KafkaProducerBolt(reportTopic), 1).globalGrouping(tfidfId);
  ...
  public static void main(String[] args) throws Exception
  {
    ...
    TfidfTopology tfidf = new TfidfTopology(topologyName, args[0], args[1]);
